  ...
  return (
    <Section id="personas" className="archer-section-navy archer-section-divider !py-16">
      ...
      <div className="relative mt-10 overflow-hidden">
        <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-24 bg-gradient-to-r from-[#001f5b] to-transparent" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-gradient-to-l from-[#001f5b] to-transparent" />
