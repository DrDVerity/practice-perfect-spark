...
export function PainReveal() {
  return (
    <Section id="pain-reveal" className="archer-section-dark archer-section-divider">
      <Reveal>
      ...
      <Reveal delay={0.15}>
        <div className="mt-14 rounded-2xl border border-primary bg-card p-10 text-center shadow-xl shadow-primary/10">
